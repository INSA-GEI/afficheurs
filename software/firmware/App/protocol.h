...
typedef struct
{
	...
	uint32_t init_time;
	char room_name[PROTOCOL_ROOM_NAME_LENGTH+1];
	char room_type[PROTOCOL_ROOM_TYPE_LENGTH+1];

	/* RTC INIT */
	uint8_t init_week_day;
	uint8_t init_time_hours;
	uint8_t init_time_minutes;
	uint8_t init_time_seconds;
	uint8_t init_date_day;
	uint8_t init_date_month;
	uint8_t init_date_year;
